...
class TVQADataset(Dataset):
    def __init__(self, opt, mode="train"):
        ...
        print('QA BERT embeddings, Video features (vfeat) loaded.')
    ...
    def __getitem__(self, index):
        ...
        if self.sub_flag:
            ...
            print("*********subtime ", self.sub_data[vid_name]["sub_time"])
